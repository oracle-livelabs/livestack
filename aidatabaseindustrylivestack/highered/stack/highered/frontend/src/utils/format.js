...
export function getPlatformColor(platform) {
 ...
 case 'student_community':
   return '#A36472';
 case 'tiktok':
 case 'short_form_student_video':
   return '#4F7D7B';
 case 'twitter':
 case 'public_student_threads':
   return '#437C94';
 case 'youtube':
 case 'campus_video':
   return '#C74634';
 case 'threads':
 case 'peer_network_threads':
   return '#796087';
 default:
   return '#6F757E';
 }
...
export function platformLabel(platform) {
 ...
 case 'twitter':
 case 'public_student_threads':
   return 'Public Student Threads';
 case 'youtube':
 case 'campus_video':
   return 'Campus Video';
 case 'threads':
 case 'peer_network_threads':
   return 'Peer Network Threads';
 default:
   return platform ? String(platform).replace(/_/g, ' ') : '-';
 }
}
