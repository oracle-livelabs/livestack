...
function buildReadme() {
  return [
    '# Bundled Higher Education Student Success Demo Dataset',
    '',
    'This archive restores the canonical seeded higher education demo dataset for the application.',
...
function createArchive() {
  ...
  return {
    ...
    fileName: `highered-student-success-demo-dataset-${IMPORT_VERSION}.zip`,
    buffer: zip.toBuffer(),
  };
}
