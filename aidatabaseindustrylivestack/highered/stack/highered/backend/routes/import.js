...
router.get('/template', async (req, res) => {
  ...
  try {
    ...
    const fileName = archive.fileName || `highered-student-success-import-template-${version}.zip`;
...
router.post('/upload', uploadSingleFile, requireDatasetAdmin, async (req, res) => {
  const service = getImportService(req);
