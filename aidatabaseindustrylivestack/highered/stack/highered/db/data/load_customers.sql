/*
 * load_customers.sql
 * 2000 synthetic students across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading synthetic students...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Synthetic students loaded: ' || v_count);
END;
/
