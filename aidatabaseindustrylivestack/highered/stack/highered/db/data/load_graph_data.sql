/*
 * load_graph_data.sql
 * Higher Education advocate connections (3000+ edges) and academic program advocate links
 */

SET SERVEROUTPUT ON
PROMPT Loading success advocate graph edges...
...
BEGIN
    ...
    -- Generate ~3000 higher education advocate connections
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Higher Education advocate connections loaded: ' || v_count);

    -- Generate academic program advocate links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Academic program advocate links loaded: ' || v_count);
END;
/
