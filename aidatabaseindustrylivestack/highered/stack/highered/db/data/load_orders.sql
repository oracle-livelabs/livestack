/*
 * load_orders.sql
 * 3000 student requests with service line items, varied statuses, and community-signal attribution
 */

SET SERVEROUTPUT ON
PROMPT Loading student requests...
...
BEGIN
    ...
    FOR i IN 1..3000 LOOP
        ...
        -- 30% of student requests are associated with a student/community signal
        ...
        -- Assign campus services center for non-pending student requests
        ...
        -- Create service routing/dispatch record for routed or completed requests
        IF v_status IN ('shipped', 'delivered') AND v_center_id IS NOT NULL THEN
            ...
            INSERT INTO shipments (
                ...
                CASE MOD(i, 4)
                    WHEN 0 THEN 'Advising'
                    WHEN 1 THEN 'Care Team'
                    WHEN 2 THEN 'Campus Ops'
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Student requests loaded: ' || v_count);
END;
/
