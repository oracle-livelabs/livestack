 ...
 * Seed data for student service demand regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic campus services segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, community signal density
 *   - student service demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Campus Services Map heat overlays
 *
...
PROMPT Loading student service demand regions...
