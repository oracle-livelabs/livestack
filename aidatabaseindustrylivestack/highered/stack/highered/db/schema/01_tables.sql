...
-- ============================================================
-- FULFILLMENT CENTERS (campus service centers / service hubs kept on baseline table name)
-- ============================================================
...
-- ============================================================
-- INVENTORY (student service capacity / campus supply units at each access center)
-- ============================================================
...
CREATE TABLE orders (
    ...
    social_source_id   NUMBER,         -- FK to social_posts if student request was influenced by a student/community signal
