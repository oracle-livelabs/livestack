/*
 * 04_vector.sql
 * Vector Search for semantic student service matching from student signal posts
...
-- ============================================================
-- PRODUCT EMBEDDINGS
-- Pre-computed vector embeddings for student service descriptions
-- Used to semantically match student/community signal text to services
-- ============================================================
...
-- Stores computed matches between signal posts and student services
-- ============================================================
...
-- Find student services semantically similar to a signal post
...
-- Batch process: find student services for all unprocessed signal posts
