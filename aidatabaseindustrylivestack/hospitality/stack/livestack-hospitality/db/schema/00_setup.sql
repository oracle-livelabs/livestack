...
-- Covers scripts: 01_tables.sql, 02_json_no-show-recovery.sql,
...
GRANT CREATE MINING MODEL    TO &&APP_SCHEMA_USER;  -- DBMS_DATA_MINING OML demo models
...
-- JSON / SODA No-Show Recovery (02_json_no-show-recovery.sql)
