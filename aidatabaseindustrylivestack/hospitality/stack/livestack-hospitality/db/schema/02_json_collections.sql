/*
 * 02_json_no-show-recovery.sql
 * JSON Document Store, event streams, and JSON Duality Views
 * Oracle 26ai — native JSON Duality Views & SODA no-show-recovery
 */
...
-- Allows REST-style JSON access to relational reservation data
-- ============================================================
...
-- ============================================================
-- JSON DUALITY VIEW: Hospitality products with service capacity
-- ============================================================
...
-- CREATE OR REPLACE can invalidate the generated lowercase collection synonyms.
-- Recompile them so USER_OBJECTS remains clean after bootstrap and copy/paste demos.
ALTER SYNONYM "orders_dv" COMPILE;
ALTER SYNONYM "products_capacity_dv" COMPILE;

COMMIT;

SELECT 'JSON no-show-recovery and duality views created' AS status FROM dual;
