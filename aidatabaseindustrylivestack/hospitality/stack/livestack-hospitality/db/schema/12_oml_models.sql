/*
 * 12_oml_models.sql
 * Hospitality demo Oracle Mbanquet-depositine Learning models
 *
...
CREATE OR REPLACE VIEW oml_guest_segment_v AS
SELECT /*+ NO_PARALLEL */
       c.guest_id,
...
LEFT JOIN (
    ...
    WHERE o.order_status NOT IN ('cancelled', 'returned')
    GROUP BY o.guest_id
) rfm ON rfm.guest_id = c.guest_id
...
BEGIN
    ...
    drop_model_if_exists('guest_SEGMENT_MODEL');
    ...
    drop_table_if_exists('OML_guest_SEGMENT_SETTINGS');
    ...
    EXECUTE IMMEDIATE 'CREATE TABLE oml_guest_segment_settings (setting_name VARCHAR2(30), setting_value VARCHAR2(4000))';
    ...
    EXECUTE IMMEDIATE q'[INSERT INTO oml_guest_segment_settings VALUES ('ALGO_NAME', 'ALGO_KMEANS')]';
    EXECUTE IMMEDIATE q'[INSERT INTO oml_guest_segment_settings VALUES ('PREP_AUTO', 'ON')]';
    EXECUTE IMMEDIATE q'[INSERT INTO oml_guest_segment_settings VALUES ('CLUS_NUM_CLUSTERS', '4')]';
    ...
    DBMS_DATA_MINING.CREATE_MODEL(
        model_name           => 'guest_SEGMENT_MODEL',
        mining_function      => DBMS_DATA_MINING.CLUSTERING,
        data_table_name      => 'OML_guest_SEGMENT_V',
        case_id_column_name  => 'GUEST_ID',
        settings_table_name  => 'OML_guest_SEGMENT_SETTINGS'
    );
    DBMS_OUTPUT.PUT_LINE('Created guest_SEGMENT_MODEL.');
