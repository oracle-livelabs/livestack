/*
 * 04_vector.sql
 * Vector Search for semantic hospitality product matching from signal bulletins
...
--
--   PAR URL (zip):
--     https://adwc4pm.objectstorage.us-ashburn-1.oci.guest-oci.com/p/TtH6hL2y25EypZ0-rrczRZ1aXp7v1ONbRBfCiT-BDBN8WLKQ3lgyW6RxCfIFLdA6/n/adwc4pm/b/OML-ai-models/o/all_MiniLM_L12_v2_augmented.zip
--
...
-- ============================================================
-- PRODUCT EMBEDDINGS compatibility marker: products are hospitality products in this demo
-- MATERIAL EMBEDDINGS
-- Pre-computed vector embeddings for hospitality product descriptions
-- Used to semantically match signal bulletin text -> hospitality products
-- ============================================================
...
-- Stores computed matches between signal bulletins and hospitality products
-- ============================================================
...
-- Find hospitality products semantically similar to a signal bulletin
...
-- Batch process: find hospitality products for all unprocessed signal bulletins
