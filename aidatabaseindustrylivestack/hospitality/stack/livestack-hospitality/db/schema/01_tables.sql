/*
 * 01_tables.sql
 * Core relational tables for Hospitality-Aware Guest Service
...
-- ============================================================
-- FULFILLMENT CENTERS (property hotels)
-- ============================================================
CREATE TABLE fulfillment_centers (
    ...
    center_type       VARCHAR2(30)   DEFAULT 'Full-Service Hotel'
                      CONSTRAINT chk_fulfillment_center_type
    ...
    capacity_units    NUMBER(10) DEFAULT 120,
...
-- ============================================================
-- INVENTORY (product capacity at each property hotel)
-- ============================================================
...
CREATE TABLE guests (
    ...
    guest_tier     VARCHAR2(20) DEFAULT 'standard'
                      CHECK (guest_tier IN ('new','standard','preferred','vip')),
