 ...
 *
 * The demo uses rolling windows such as "last 30 days" and "today's forecast".
...
PROMPT =====================================================
PROMPT Refreshing hospitality demo data date window
PROMPT =====================================================
...
BEGIN
  ...
  shift_ts('shipments', 'routed_at');
  shift_ts('shipments', 'completed_at');
