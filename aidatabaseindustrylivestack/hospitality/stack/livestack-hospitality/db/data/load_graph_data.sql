/*
 * load_graph_data.sql
 * Signal-source connections (3000+ edges) and property-source links
 */
...
BEGIN
    ...
    -- Generate property-source links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Property-source links loaded: ' || v_count);
END;
/
