 ...
 *
 * demand_regions captures geographic demand segments with:
 ...
 *
 * Used by: Service-pressure forecasting and property service map heat overlays
 *
 * Run after 05_spatial.sql schema creation and after guests are loaded.
 */
