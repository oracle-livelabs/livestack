/*
 * load_guests.sql
 * 2000 guest and booker profiles across US source demands
 */
...
BEGIN
    ...
    FOR i IN 1..2000 LOOP
        ...
        v_email := LOWER(v_fnames(MOD(i, v_fnames.COUNT) + 1)) || '.' ||
                   ...
                   i || '@example.hospitality-demo.example';
        ...
        BEGIN
            INSERT INTO guests (
                ...
                latitude, longitude, guest_tier, lifetime_value
            ) VALUES (
                v_email,
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('guests loaded: ' || v_count);
END;
/
