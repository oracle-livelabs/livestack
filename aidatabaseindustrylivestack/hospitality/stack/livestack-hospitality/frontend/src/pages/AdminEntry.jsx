...
export default function AdminEntry({
  ...
  const datasetLabel = useMemo(() => {
    if (!activeDataset) return 'hospitality demo data';
    const label = activeDataset.label || activeDataset.source || 'hospitality demo data';
      ...
      >
        ...
        <div className="mt-6 glass-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold">Restore Hospitality LiveStack Demo Data</h2>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              ...
              Restore Hospitality LiveStack Demo Data
            </button>
          </div>
          {restorePreview && (
