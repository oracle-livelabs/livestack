    ...
    <div className="mb-3">
      ...
      {open && (
        ...
        >
          ...
          >
            <div className="w-6 h-6 flex items-center justify-center border" style={{ borderColor: 'rgba(167, 53, 41,0.22)', borderRadius: '4px' }}>
...
export function FeatureBadge({ label, color = 'blue' }) {
  const palettes = {
    orange: { accent: '#8A4E2F', background: 'rgba(138, 78, 47,0.12)', borderColor: 'rgba(138, 78, 47,0.28)' },
    ...
    cyan: { accent: '#3E6F4D', background: 'rgba(62, 111, 77,0.12)', borderColor: 'rgba(62, 111, 77,0.28)' },
    red: { accent: '#A73529', background: 'rgba(167, 53, 41,0.12)', borderColor: 'rgba(167, 53, 41,0.28)' },
