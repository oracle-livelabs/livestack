  ...
  return (
    ...
    >
      {!collapsed && (
        ...
        >
          <div className="h-full" style={{ width: dragging ? 3 : 2, background: dragging ? '#a73529' : 'transparent' }} />
          <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity" style={{ background: 'rgba(167, 53, 41,0.12)' }} />
        </div>
      )}
