...
export function getMomentumColor(flag) {
  switch (flag) {
    case 'mega_viral': return '#A73529';
    case 'viral': return '#8A4E2F';
    case 'rising': return '#8A4E2F';
...
export function getMentionTypeLabel(type) {
  switch (type) {
    ...
    case 'hashtag': return 'Operations feed';
...
export function getPlatformLabel(platform) {
  switch (platform) {
    case 'instagram': return 'Guest review';
    case 'tiktok': return 'Service recovery alert';
    case 'twitter': return 'OTA channel notice';
    case 'youtube': return 'Demand signal feed';
    case 'threads': return 'Property operations alert';
