...
export default function AdminEntry({
  ...
  const headerContent = isOverlay ? 'Use Your Own Public Service Data' : 'Dataset Control';
  const headerDescription = isOverlay
    ? 'The State and Local Government demo dataset stays active by default. Upload your own v1 ZIP, validate it, or preview a restore before executing any replacement.'
    : 'Start on the seeded State and Local Government demo dataset, or load your own v1 ZIP before entering the experience.';
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="mt-2 text-xs text-[var(--color-text-dim)] max-w-3xl">
              Dataset validation, upload, restore preview, restore, and job status require a Global VPD Admin.
              Use only synthetic, anonymized, or approved de-identified data. Never upload resident production data,
              credentials, wallets, or other secrets to this demo environment.
            </p>
          </div>
        ...
        <div className="mt-6 glass-card p-5 space-y-4">
          ...
          <p className="text-xs text-[var(--color-text-dim)]">
            Preview the State and Local Government demo dataset import to see row counts and warnings, then execute the restore to overwrite the current data.
          </p>
          <div className="flex flex-wrap gap-3">
            <button
              className="btn-ghost inline-flex items-center gap-2"
