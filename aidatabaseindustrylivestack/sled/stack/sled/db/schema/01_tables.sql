...
-- ============================================================
-- FULFILLMENT CENTERS (service access centers / service hubs kept on baseline table name)
-- ============================================================
...
-- ============================================================
-- INVENTORY (public service capacity / public works material units at each access center)
-- ============================================================
...
CREATE TABLE orders (
    ...
    social_source_id   NUMBER,         -- FK to social_posts if service request was influenced by a resident/community signal
...
CREATE TABLE app_users (
    ...
    email             VARCHAR2(300),
	    ...
	    access_scope      VARCHAR2(20) NOT NULL
	                      CONSTRAINT ck_app_users_access_scope
