/*
 * load_graph_data.sql
 * State and Local Government advocate connections (3000+ edges) and public program advocate links
 */

SET SERVEROUTPUT ON
PROMPT Loading community partner graph edges...
...
BEGIN
    ...
    -- Generate ~3000 community partner connections
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('State and Local Government advocate connections loaded: ' || v_count);

    -- Generate public program advocate links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Public Service program advocate links loaded: ' || v_count);
END;
/
