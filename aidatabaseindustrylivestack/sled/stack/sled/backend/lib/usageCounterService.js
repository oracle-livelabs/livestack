...
const DEFAULT_DEMO_ID = 'state-local-government';
const APP_NAME = 'state-local-government-demo';
...
function normalizeOperation(value) {
  ...
  if (normalized.includes('upload') || normalized.includes('import')) return 'upload';
...
function buildPayload(config, eventContext = {}, timestamp = new Date().toISOString()) {
  return {
    ...
    operation: normalizeOperation(eventContext.operation),
