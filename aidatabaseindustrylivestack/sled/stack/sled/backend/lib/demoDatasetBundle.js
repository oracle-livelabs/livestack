...
function buildReadme() {
  return [
    '# Bundled State and Local Government Service Operations Demo Dataset',
    '',
    'This archive restores the canonical seeded State and Local Government demo dataset for the application.',
...
function createArchive() {
  ...
  return {
    ...
    fileName: `sled-service-operations-demo-dataset-${IMPORT_VERSION}.zip`,
    buffer: zip.toBuffer(),
  };
}
