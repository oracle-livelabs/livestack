...
6. Download the LiveStack package to the VM.
    ...
    ```bash
    <copy>
    curl -L -o livestack-sled.zip "https://c4u02.objectstorage.us-ashburn-1.oci.customer-oci.com/p/9DEArLjsgbKXuJgQtSG95E8hMXRFtxgHR8jiHbqz4HgyVYXVnSo0SC_s-zq5CJA3/n/c4u02/b/hosted-files/o/livestack-sled.zip"
    </copy>
    ```
