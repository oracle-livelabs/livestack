/*
 * load_customers.sql
 * 2000 synthetic customers across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading synthetic customers...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Synthetic customers loaded: ' || v_count);
END;
/
