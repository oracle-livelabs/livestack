 ...
 * Seed data for production demand regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic plant capacity segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, supplier signal density
 *   - production demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Plant Capacity Map heat overlays
 *
...
PROMPT Loading production demand regions...
