/*
 * 01_tables.sql
 * Core relational tables for Seer Media content revenue and distribution operations
...
-- ============================================================
-- FULFILLMENT CENTERS (distribution hubs / service hubs kept on baseline table name)
-- ============================================================
...
-- ============================================================
-- INVENTORY (content asset capacity / production supply units at each distribution hub)
-- ============================================================
...
CREATE TABLE orders (
    ...
    social_source_id   NUMBER,         -- FK to social_posts if campaign order was influenced by a audience/social signal
