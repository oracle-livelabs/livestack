/*
 * load_graph_data.sql
 * Media and Entertainment creator connections (3000+ edges) and studio or label creator links
 */

SET SERVEROUTPUT ON
PROMPT Loading creator graph edges...
...
BEGIN
    ...
    -- Generate ~3000 media creator connections
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Media and Entertainment creator connections loaded: ' || v_count);

    -- Generate studio or label creator links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Studio or label creator links loaded: ' || v_count);
END;
/
