 ...
 * Seed data for audience demand regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic content distribution segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, community signal density
 *   - audience demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Content Distribution Map heat overlays
 *
...
PROMPT Loading audience demand regions...
