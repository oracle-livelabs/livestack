/*
 * load_customers.sql
 * 2000 synthetic audience accounts across US metro areas
 */

SET SERVEROUTPUT ON
PROMPT Loading synthetic audience accounts...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Synthetic audience accounts loaded: ' || v_count);
END;
/
