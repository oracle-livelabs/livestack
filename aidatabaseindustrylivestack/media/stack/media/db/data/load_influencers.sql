 ...
 * 500 media creators, fandom voices, and entertainment analysts across social platforms
 */

SET SERVEROUTPUT ON
PROMPT Loading media creators and fandom voices...
...
BEGIN
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Media and Entertainment creators loaded: ' || v_count);
END;
/
