...
function buildReadme() {
  return [
    '# Bundled Media and Entertainment Content Intelligence Demo Dataset',
    '',
    'This archive restores the canonical seeded media demo dataset for the application.',
...
function createArchive() {
  ...
  return {
    ...
    fileName: `media-content-intelligence-demo-dataset-${IMPORT_VERSION}.zip`,
    buffer: zip.toBuffer(),
  };
}
