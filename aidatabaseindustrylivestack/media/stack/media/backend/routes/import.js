...
router.get('/template', async (req, res) => {
  ...
  try {
    ...
    const fileName = archive.fileName || `media-content-intelligence-import-template-${version}.zip`;
...
router.get('/status/:jobId', requireDemoIdentity, requireDemoAdmin, async (req, res) => {
  const service = getImportService(req);
