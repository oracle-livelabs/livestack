  ...
  const checks = [
    {
      ...
      screen: 'Energy Operations Command Center',
      table: 'orders',
      column: 'created_at',
      objects: ['orders'],
      min: 1,
      expected: 'At least one utility service request in the last 7 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM orders
        WHERE CAST(created_at AS DATE) >= SYSDATE - 7
      `,
      message: 'Energy Operations Command Center requires recent service request records for 7-day KPIs.',
    },
    {
      ...
      objects: ['orders'],
      min: 1,
      expected: 'At least one utility service request in the last 30 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM orders
        WHERE CAST(created_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Energy Operations Command Center requires service request records for 30-day KPIs.',
    },
    {
      ...
      min: 1,
      expected: 'At least one reliability, production, or compliance signal in the last 7 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM social_posts
        WHERE CAST(posted_at AS DATE) >= SYSDATE - 7
      `,
      message: 'Energy Operations Command Center velocity and signal KPIs require recent reliability, production, or compliance signals.',
    },
    {
      ...
      objects: ['social_posts'],
      min: 1,
      expected: 'At least one reliability, production, or compliance signal in the last 30 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM social_posts
        WHERE CAST(posted_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Energy Operations Command Center 30-day signal summaries require restored signal timestamps.',
    },
    {
      id: 'quality-signals-view-last-7-days',
      screen: 'Reliability, Production & Compliance Signals',
      table: 'reliability_load_signals_v',
      column: 'signal_timestamp',
      objects: ['reliability_load_signals_v'],
      min: 1,
      expected: 'At least one reliability, production, or compliance signal in the last 7 days through the semantic view.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM reliability_load_signals_v
        WHERE CAST(signal_timestamp AS DATE) >= SYSDATE - 7
      `,
      message: 'Reliability, Production & Compliance Signals feed should expose recent records through reliability_load_signals_v.',
    },
    {
      ...
      objects: ['reliability_load_signals_v'],
      min: 1,
      expected: 'At least one reliability, production, or compliance signal timestamp should be within the last 2 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM reliability_load_signals_v
    ...
    },
    {
      ...
      screen: 'Field Operations Logistics Map',
      ...
      `,
      message: 'Field Operations Logistics Map requires forecast records anchored to the current restore window.',
    },
    {
      id: 'forecast-start-after-latest-history',
      screen: 'Asset Risk & Capacity Analytics',
      table: 'demand_forecasts',
      column: 'forecast_date',
    ...
    },
    {
      ...
      `,
      message: 'Field Operations Logistics Map demand-region layers should not be stale after restore.',
    },
    {
      ...
      sql: `
        ...
        WHERE CAST(updated_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Field Operations Logistics Map site KPIs require recent inventory update timestamps.',
    },
    {
      id: 'service-requests-last-30-days',
      screen: 'Utility Service Requests',
      table: 'utility_service_requests',
      column: 'created_at',
      objects: ['utility_service_requests'],
      min: 1,
      expected: 'At least one utility service request created in the last 30 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM utility_service_requests
        WHERE CAST(created_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Utility Service Requests should display recently created request records after restore.',
    },
    {
      ...
      objects: ['utility_service_requests'],
      min: 1,
      expected: 'At least one utility service request should be within the last 2 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM utility_service_requests
    ...
    },
    {
      ...
      screen: 'Utility Service Requests',
      table: 'field_crew_routes_v',
      column: 'shipped_at',
      objects: ['field_crew_routes_v'],
      min: 1,
      ...
      `,
      message: 'Utility Service Requests route tab requires recent logistics milestones.',
    },
    {
    ...
    },
    {
      ...
      `,
      message: 'Asset Risk & Capacity Analytics requires enough recent service requests for rolling-window queries.',
    },
    {
      ...
      `,
      message: 'Asset Risk & Capacity Analytics requires enough recent signal rows for rolling-window features.',
    },
    {
    ...
    {
      id: 'ask-utilities-service-requests-view-last-30-days',
      screen: 'Ask Energy & Utilities Data',
      table: 'utility_service_requests_v',
      column: 'created_at',
      objects: ['utility_service_requests_v'],
      min: 1,
      expected: 'At least one recent service request through the Ask Data semantic view.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM utility_service_requests_v
        WHERE CAST(created_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Ask Energy & Utilities Data should be able to answer recent service request questions after restore.',
    },
    {
      id: 'ask-utilities-quality-signals-view-last-30-days',
      screen: 'Ask Energy & Utilities Data',
      table: 'reliability_load_signals_v',
      column: 'signal_timestamp',
      objects: ['reliability_load_signals_v'],
      min: 1,
      expected: 'At least one recent reliability, production, or compliance signal through the Ask Data semantic view.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM reliability_load_signals_v
        WHERE CAST(signal_timestamp AS DATE) >= SYSDATE - 30
      `,
      message: 'Ask Energy & Utilities Data should be able to answer recent reliability, production, or compliance signal questions after restore.',
    },
    {
      id: 'service-restoration-graph-relationships-last-30-days',
      screen: 'Operational Event Graph',
      table: 'utility_graph_relationships',
      column: 'last_interaction',
      objects: ['utility_graph_relationships'],
      optional: true,
      skipWhenNoRows: 'utility_graph_relationships',
      min: 1,
      expected: 'If graph relationships are present, at least one graph event should be in the last 30 days.',
      sql: `
        SELECT COUNT(*) AS actual
        FROM utility_graph_relationships
    ...
    },
    {
      ...
      screen: 'Operational Event Graph',
      table: 'restoration_cases',
      column: 'created_at',
      objects: ['restoration_cases'],
      optional: true,
      skipWhenNoRows: 'restoration_cases',
      min: 1,
    ...
    },
    {
      ...
      screen: 'Energy & Utilities AI Agent Console',
      table: 'agent_actions',
      column: 'created_at',
      ...
      sql: `
        ...
        WHERE CAST(created_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Energy & Utilities AI Agent Console audit records should be recent when present.',
    },
    {
      ...
      sql: `
        ...
        WHERE CAST(created_at AS DATE) >= SYSDATE - 30
      `,
      message: 'Energy & Utilities AI Agent Console event stream should be recent when present.',
    },
  ];
