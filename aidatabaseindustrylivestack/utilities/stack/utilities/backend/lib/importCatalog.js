...
const TABLES = [
  ...
  {
    name: 'shipments',
    displayName: 'Field Crew Routes',
    fileName: 'field_crew_routes.csv',
    required: false,
    pk: 'shipment_id',
    columns: [
...
const TEMPLATE_NOTES = [
  ...
  'inventory.csv is required. field_crew_routes.csv is optional and can be omitted.',
  'When optional graph, field crew route, or demand files are omitted, the importer regenerates fallback data.',
  'Domain labels keep the original schema names for compatibility: brands are manufacturers, products are utility operations, influencers are signal sources, and social_posts are regulatory or supply bulletins.',
