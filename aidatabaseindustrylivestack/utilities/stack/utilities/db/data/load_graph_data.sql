/*
 * load_graph_data.sql
 * Utilities advocate connections (3000+ edges) and utility program advocate links
 */

SET SERVEROUTPUT ON
PROMPT Loading field crew graph edges...
...
BEGIN
    ...
    -- Generate ~3000 utilities advocate connections
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Utilities advocate connections loaded: ' || v_count);

    -- Generate utility program advocate links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Utility program signal links loaded: ' || v_count);
END;
/
