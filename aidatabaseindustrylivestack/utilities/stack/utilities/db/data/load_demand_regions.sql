 ...
 * Seed data for service territory, repair priority, production, and compliance regions
 *
 * WHY THIS WAS EMPTY:
 ...
 *
 * demand_regions captures geographic Energy & Utilities operating segments with:
 *   - SDO_GEOMETRY boundary polygon (WGS84 / SRID 4326)
 *   - population, avg_income, community signal density
 *   - service territory demand index (0-100, Oracle AI-scored)
 *
 * Used by: OML Analytics and Field Operations Logistics Map heat overlays
 *
...
PROMPT Loading service territory demand regions...
...
INSERT INTO demand_regions (region_name, region_type, boundary, population, avg_income, social_density, demand_index)
VALUES (
  'Permian Basin Production Zone', 'region',
  SDO_GEOMETRY(
    2003, 4326, NULL,
    SDO_ELEM_INFO_ARRAY(1, 1003, 1),
    SDO_ORDINATE_ARRAY(
...
INSERT INTO demand_regions (region_name, region_type, boundary, population, avg_income, social_density, demand_index)
VALUES (
  'Gulf Coast Pipeline and LNG Corridor', 'region',
  SDO_GEOMETRY(
    2003, 4326, NULL,
    SDO_ELEM_INFO_ARRAY(1, 1003, 1),
    SDO_ORDINATE_ARRAY(
  ...
  7200000, 64000, 13.4, 88
);

INSERT INTO demand_regions (region_name, region_type, boundary, population, avg_income, social_density, demand_index)
VALUES (
  'Corpus Christi Downstream Operating Zone', 'region',
  SDO_GEOMETRY(
    2003, 4326, NULL,
    SDO_ELEM_INFO_ARRAY(1, 1003, 1),
    SDO_ORDINATE_ARRAY(
  ...
  475000, 61000, 10.6, 84
);

INSERT INTO demand_regions (region_name, region_type, boundary, population, avg_income, social_density, demand_index)
VALUES (
  'Puget Sound Water and Wastewater Compliance Zone', 'region',
  SDO_GEOMETRY(
    2003, 4326, NULL,
    SDO_ELEM_INFO_ARRAY(1, 1003, 1),
    SDO_ORDINATE_ARRAY(
  ...
  4300000, 91000, 18.9, 87
);

COMMIT;
PROMPT Demand regions loaded: 24
