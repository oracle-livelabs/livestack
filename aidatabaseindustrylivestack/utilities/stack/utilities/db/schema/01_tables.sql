/*
 * 01_tables.sql
 * Core relational tables for Energy & Utilities Signal Intelligence & Operations
...
CREATE TABLE influencers (
    ...
    platform          VARCHAR2(50) DEFAULT 'Reliability Signal'
                      CHECK (platform IN (
                        'Reliability Signal',
                        'Production Signal',
...
-- Atomic dataset-generation journal. A serialized copy of the prior
-- importable base generation is captured before destructive work because OML
-- model DDL can commit implicitly. Startup restores that prior generation and
-- rebuilds all required features before serving if work is interrupted.
