 ...
 *      including 11_utilities_semantic_views.sql for utilities-named query objects.
 *
 * SQLcl example:
...
GRANT CREATE PROCEDURE       TO &&APP_SCHEMA_USER;  -- repair actions, functions
...
SELECT 'Setup complete.' ||
       ...
       ' and run the schema scripts in order, including 11_utilities_semantic_views.sql.' AS next_step
FROM   dual;
