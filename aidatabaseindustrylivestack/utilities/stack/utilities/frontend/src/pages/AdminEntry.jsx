...
export default function AdminEntry({
  ...
  const headerEyebrow = isOverlay ? 'Utility Dataset Tool' : 'Admin Entry';
  const headerContent = isOverlay ? 'Use Your Own Utility Data' : 'Utility Dataset Control';
  ...
  const quickActionLabel = isOverlay ? 'Jump To Upload' : 'Load Utility Dataset';
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="mt-2 text-xs tone-sienna max-w-3xl">
              Use synthetic or de-identified utility data only. Do not upload customer personal information or operationally sensitive grid data.
            </p>
          </div>
        ...
        <div className="mt-6 glass-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold">Restore Utility Demo Data</h2>
