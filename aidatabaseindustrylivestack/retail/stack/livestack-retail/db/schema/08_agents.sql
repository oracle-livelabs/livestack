/*
 * 08_agents.sql
 * Optional Select AI Agent Orchestration - Oracle 26ai DBMS_CLOUD_AI_AGENT
 *
 * The normal LiveStack runtime uses the backend's local Ollama assistant.
 * scripts/bootstrap_db.sh extracts only the PL/SQL helper functions from this
 * file. The DBMS_CLOUD_AI_AGENT sections are kept as optional manual examples
 * for environments where Select AI profiles are configured outside git.
 *
 * Components:
 ...
 *
 * Prerequisites:
 *   - Select AI profiles created manually with credentials supplied outside git
...
-- Optional Select AI profiles can read these to understand your schema.
-- Good comments improve generated queries.
-- ============================================================
...
COMMENT ON COLUMN products.category IS 'Product category: Outdoor, Footwear, Fitness, Sports Tech, Sports Nutrition, Cycling, etc.';
