...
-- Optional Select AI / AI Agent framework support.
-- LiveStack uses Ollama at the application layer. If these packages are
-- present in the target database, grant them only for manual experiments.
-- Do not check DBMS_CLOUD credentials or private keys into this repository.
BEGIN
    FOR stmt IN (
...
-- Allows the application schema to make outbound HTTPS calls for optional
-- manual Select AI / AI Agent experiments.
-- ============================================================
BEGIN
