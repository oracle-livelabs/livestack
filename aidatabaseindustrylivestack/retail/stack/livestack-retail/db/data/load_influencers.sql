 ...
 * 500 sporting-goods creators across platforms
 */
...
DECLARE
    ...
    v_prefixes t_str := t_str(
        'trail','summit','hike','run','cycle','camp','climb','gear',
        'fit','outdoor','endurance','terrain','hydration','recovery','coach','field',
        'route','alpine','river','stadium','peak','ridge','basecamp','trek',
        'stride','paddle','court','league','rally','ascent','switchback','summitlab',
        'pack','boot','trailhead','mountain','workout','routewise','campsite','cliffrun',
        'marathon','gravel','lift','stretch','matchday','outfitter','venture','gearhub',
        'compass','distance','wildtrack','trailmix'
    );
    ...
    v_niches    t_str := t_str(
        'Outdoor','Trail Running','Hiking','Fitness','Cycling','Camping','Team Sports',
        'Water Sports','Sports Tech','Recovery','Sports Nutrition','Climbing',
        'Footwear Reviews','Gear Testing','Training'
    );
