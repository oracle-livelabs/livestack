/*
 * load_returns.sql
 * Demo returns workload for Seer Sporting Goods retail operations intelligence.
 * Safe to run repeatedly after the base sporting-goods retail data load.
 */
...
PROMPT =====================================================
PROMPT Loading Seer Sporting Goods returns demo data
PROMPT =====================================================
...
INSERT INTO return_decisions (
  return_id, decision_type, decision_summary, confidence_score, created_by, created_at
) VALUES (
  1, 'Approve',
  'Draft instant credit and carrier recovery claim. Oracle evidence shows low risk and strong damage match.',
  0.94, 'returns_ai_agent', SYSTIMESTAMP - INTERVAL '90' MINUTE
);
INSERT INTO return_decisions (
  return_id, decision_type, decision_summary, confidence_score, created_by, created_at
) VALUES (
  3, 'Deny',
  'Draft denial due to serial mismatch and missing accessories under electronics policy.',
  0.91, 'returns_ai_agent', SYSTIMESTAMP - INTERVAL '30' MINUTE
);
