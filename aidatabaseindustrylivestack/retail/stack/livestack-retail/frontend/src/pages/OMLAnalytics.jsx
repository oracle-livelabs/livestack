...
const TABS = [
  { key: 'demand',    label: 'Demand Surge Predictions',             buttonLabel: 'Demand Surge',     iconClass: 'oj-fwk-icon-sortrelevancehigh', color: '#AA643B' },
  ...
  { key: 'inventory', label: 'Inventory Intelligence',               buttonLabel: 'Inventory',         iconClass: 'oj-fwk-icon-tree-document',     color: '#796087' },
];
...
function StatCard({ iconClass, label, value, sub, color = '#C74634', badge }) {
  return (
    <div className="stat-card dashboard-stat-card oml-stat-card">
      {badge && (
        <span
      ...
      <div className="dashboard-stat-card__icon oml-stat-card__icon" style={{ background: `${color}18`, color }}>
        <JetGlyph iconClass={iconClass} />
      </div>
      <div className="dashboard-stat-card__copy oml-stat-card__copy">
        <p className="dashboard-stat-card__value oml-stat-card__value">{value}</p>
        <p className="dashboard-stat-card__label oml-stat-card__label">{label}</p>
      </div>
      {sub && <p className="dashboard-stat-card__meta oml-stat-card__meta">{sub}</p>}
    </div>
  );
}
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-[var(--color-text)] leading-relaxed">
          ...
          <code className="text-xs tone-sienna">DBMS_DATA_MINING.CREATE_MODEL</code> on 12 social engagement
...
FROM daily_rev CROSS JOIN params CROSS JOIN glm_stats;`} />
      <div className="oml-model-flow">
        ...
        <DiagramBox label="Per-Order Revenue Prediction" sub="GLM scores each order inline in SQL" color="#437C94" />
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-[var(--color-text)] leading-relaxed">
          ...
          <code className="text-xs tone-teal">DBMS_DATA_MINING.CREATE_MODEL</code> on 8 product behavioral
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-[var(--color-text)] leading-relaxed">
          ...
          against on-hand stock to identify supply risk - products where customer demand signals may exceed available inventory.
    ...
    <div className="space-y-6 fade-in">
      ...
      <div>
        <h2 className="text-2xl font-bold flex items-center gap-2">
          <JetGlyph iconClass="oj-fwk-icon-view" className="oml-header-glyph tone-plum" /> AI Forecasting and Retail Risk Analytics
        </h2>
        <p className="text-sm text-[var(--color-text-dim)] mt-1">
          Forecast AllTerrain Hiking Boots demand, segment customers, predict revenue, cluster sporting-goods products, and score inventory risk with Oracle Machine Learning and SQL analytics inside the database. <span className="tone-plum">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          label="Sporting Goods with Demand Surge"
        ...
        <StatCard
          ...
          value={summaryLoading ? '...' : ((summary?.REVENUE_R2 ?? summary?.revenue_r2) != null
      ...
      {activeTab === 'demand' && (
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--color-text-dim)] mt-0.5">
                Products scored by DEMAND_SURGE_MODEL - Oracle DBMS_DATA_MINING Random Forest (50 trees). Products showing strong projected demand growth based on customer activity, social momentum, and purchasing signals.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <JetSelectSingle
          ...
          {demandLoading ? (
            ...
            <p className="text-sm text-[var(--color-text-dim)] py-4 text-center">No products with sufficient customer signal momentum in this window.</p>
          ) : (
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-wider border-b border-[var(--color-border)]">
                      ...
                      <th className="text-right py-2 px-2">Predicted Units</th>
          ...
          <div className="rounded-lg p-3 text-[10px] flex flex-wrap gap-x-6 gap-y-1"
            ...
            <span><strong>Features:</strong> 12 - category, price, signal posts, sentiment, likes, shares, views, momentum, spike_posts, rising_posts, units_sold, revenue</span>
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--color-text-dim)] mt-0.5">
                AI groups products based on shared customer behavior, product attributes, purchasing patterns, and semantic similarity.
              </p>
            </div>
            <div className="flex items-center gap-2">
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-xs text-[var(--color-text-dim)] mt-0.5">
                DEMAND_SURGE_MODEL predictions × live inventory. Identify products at risk of stock shortages using AI-powered demand forecasting, inventory monitoring, and retail trend analysis.
              </p>
            </div>
            <JetButton
          ...
          {invLoading ? (
            ...
            <>
              ...
              <div className="rounded-lg p-3 text-[10px] flex flex-wrap gap-x-6 gap-y-1"
                ...
                <span><strong>Engine:</strong> Oracle DBMS_DATA_MINING - customer signal demand surge → supply and returns risk assessment</span>
              </div>
            </>
          )}
        </section>
