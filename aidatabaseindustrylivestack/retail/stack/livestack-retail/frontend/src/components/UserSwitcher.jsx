...
export default function UserSwitcher() {
  ...
  if (loading || !currentUser) {
    return <div className="user-switcher user-switcher--loading" aria-hidden="true" />;
  }
  ...
  return (
    <div className="user-switcher relative" ref={ref}>
      <button
      ...
      {open && (
        ...
        >
          ...
          >
            BEGIN retail_security_pkg.set_user_context('{currentUser.USERNAME}'); END;
          </div>
        </div>
      )}
    </div>
