...
## Task 3: Find the nearest service center with capacity

![Nearest Service Center panel with find_nearest_centers results highlighted](images/nearest-service-center.png)

Perform the following set of steps to show how the application turns a client and product selection into ranked service-center recommendations.
...
## Task 5: Investigate a capacity alert
