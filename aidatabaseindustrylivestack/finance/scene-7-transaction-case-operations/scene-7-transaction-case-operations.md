...
![Transaction and Case Operations workspace with transaction 513063 highlighted](images/client-transactions-cases.png)
...
4. Focus on transaction **#513063**.

In the current demo dataset, transaction **#513063** is for **Anthony Wilson** in **Minneapolis, Minnesota**. It is marked **routed**, contains **4** service line items, totals **$4,168.95**, and is currently assigned to **West Jordan Mountain Client Center**. This transaction will be the data point used through the rest of the scene.

**Note:** Sample values may change after data refreshes or rebuilds. Verify live output before presenting, then explain the business takeaway.

## Task 2: Inspect the relational transaction detail

![Operational transaction detail for transaction 513063](images/transaction-relational-detail.png)
...
![API Document View for transaction 513063](images/transaction-json-duality-view.png)
...
3. Review the JSON document for transaction **513063**.
4. Notice that the document contains `_id` **513063**, `customerId` **64790**, status **routed**, total **4168.95**, shipping cost **14.99**, demand score **12.14**, the created timestamp, and **4** nested line items.
...
![Transaction routing and recommended service center for transaction 513063](images/transaction-routing-context.png)
...
For transaction **#513063**, the current assigned center is **West Jordan Mountain Client Center** in **West Jordan, Utah**, about **1,596 km** from the client. The recommended center is **Edwardsville Central Operations Site** in **Edwardsville, Kansas**, about **670.2 km** away. It is **925.8 km closer**, has **100%** capacity coverage with **5 of 5** required units available, provides full **4 of 4** service coverage, and has a reason score of **85.0**. This is a strong example of the application detecting a better operational routing decision from the same transaction record.
