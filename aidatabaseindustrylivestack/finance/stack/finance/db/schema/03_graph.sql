...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE v1.display_name = 'Regulatory Intelligence Stream - OCC 01'
    COLUMNS (
        v2.display_name,
        v2.influence_score,
        v2.follower_count
...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE a.display_name = 'FINRA Monitoring Feed 01'
      AND b.display_name = 'Client Exposure Engine - Branch 01'
    COLUMNS (
