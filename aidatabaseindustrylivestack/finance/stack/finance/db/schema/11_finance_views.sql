 ...
 * Finance-facing semantic layer for the Seer Bank LiveStack.
 *
...
SELECT
  ...
  follower_count AS source_exposure_count,
...
SELECT
  ...
  CASE center_type
    ...
    WHEN 'store' THEN 'Branch Services'
...
SELECT
  ...
  product_id AS financial_product_id,
  center_id AS service_center_id,
  quantity_on_hand AS processing_capacity,
  quantity_reserved AS active_processing_load,
