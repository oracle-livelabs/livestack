/*
 * load_graph_data.sql
 * Signal-source connections (3000+ edges) and institution-source links
 */
...
BEGIN
    ...
    -- Generate institution-source links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Institution-source links loaded: ' || v_count);
END;
/
