/*
 * load_orders.sql
 * 3000 client transactions with line items, varied statuses, and signal attribution
 */
...
BEGIN
    ...
    FOR i IN 1..3000 LOOP
        ...
        -- 30% of orders are signal-driven by regulatory, credit, or market bulletins
        ...
        -- Assign branch service center for non-pending orders
