...
const EXAMPLE_QUESTIONS = [
  { text: 'Which Seer financial products have the highest fraud and Anti-Money Laundering (AML) signal severity?', iconClass: 'oj-fwk-icon-sortrelevancehigh', team: 'signals' },
  { text: 'Show transaction exposure by financial product category', iconClass: 'oj-fwk-icon-grid', team: 'exposure' },
  { text: 'Find operations centers with rising investigation SLA pressure.', iconClass: 'oj-fwk-icon-tree-document', team: 'service' },
  { text: 'Show exposure from signal-linked transactions.', iconClass: 'oj-fwk-icon-info', team: 'exposure' },
  { text: 'Find critical fraud and compliance bulletins in the last 24 hours', iconClass: 'oj-fwk-icon-sortrelevancehigh', team: 'signals' },
  { text: 'Which fraud cases have the highest connected account value?', iconClass: 'oj-fwk-icon-node-expand', team: 'fraud' },
  { text: 'Find the nearest compliant operations center for an AML review case in Miami', iconClass: 'oj-fwk-icon-arrowtail-e', team: 'service' },
];
    ...
    <div className="glass-card overflow-hidden" style={{ border: '1px solid rgba(79,125,123,0.25)' }}>
      ...
      <div className="px-5 py-3 flex items-center justify-between" style={{ background: 'rgba(79,125,123,0.06)', borderBottom: '1px solid rgba(79,125,123,0.15)' }}>
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold">Coordinate Operations Agents</h3>
            <p className="text-[10px] text-[var(--color-text-dim)]">
              Ask an operations question and the app sends it to the <span className="font-semibold text-[var(--color-text)]">Fraud & Compliance</span>, <span className="font-semibold text-[var(--color-text)]">Client Service Routing</span>, or <span className="font-semibold text-[var(--color-text)]">Transaction Exposure</span> agent
            </p>
          </div>
        </div>
        {messages.length > 0 && (
          ...
          <div className="space-y-3 py-4">
            <div className="text-center mb-4">
              ...
              <p className="text-[10px] text-[var(--color-text-dim)] mt-1">
                Model reasoning with Oracle data access, workflow tools, and action logging
              </p>
            </div>
...
const FALLBACK_PROFILE_INFO = {
  SC_LLAMA_PROFILE: {
    label: 'Runtime Profile 1',
    short: 'Runtime Profile 1',
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-[var(--color-text)] leading-relaxed">
              ...
              <code className="text-xs font-semibold" style={{ color: 'var(--color-text)', borderBottom: '1px solid #437C94' }}>CLIENT_SERVICE_ROUTING_AGENT</code>, <code className="text-xs font-semibold" style={{ color: 'var(--color-text)', borderBottom: '1px solid #4C825C' }}>COMMERCE_TEAM</code>) route work across
              signal analysis, service coverage, transaction exposure, and fraud tasks. Oracle stores the source data, runs the queries, and records decisions in
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                { team: 'CLIENT_SERVICE_ROUTING_AGENT', agent: 'SERVICE_ROUTING_AGENT', tools: ['COMMERCE_SQL_TOOL', 'CHECK_SERVICE_CAPACITY_TOOL', 'ROUTE_SERVICE_CASE_TOOL', 'LOG_DECISION_TOOL'], color: '#AA643B' },
          ...
          <div>
            ...
            <div className="space-y-1" style={{ fontSize: 9 }}>
              <DiagramBox label="Critical Seer Risk Signal Detected" sub="social_posts · risk severity >= 75" color="#AA643B" />
              ...
              <DiagramBox label="Risk signal detector" sub="Vector match · institution graph centrality" color="#A36472" />
              <div className="text-center text-[var(--color-text-dim)]">↓</div>
              <DiagramBox label="CLIENT_SERVICE_ROUTING_AGENT" sub="Service-capacity check · SLA routing" color="#437C94" />
              <div className="text-center text-[var(--color-text-dim)]">↓</div>
              <DiagramBox label="COMMERCE_TEAM" sub="Revenue exposure · transaction routing" color="#4C825C" />
              <div className="text-center text-[var(--color-text-dim)]">↓</div>
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-[var(--color-text-dim)] mt-1">
            Seer agent teams coordinate fraud, risk, service, and exposure decisions while Oracle governs data access, workflow execution, and action logging.
          </p>
        </div>
        <div className="flex items-center gap-2">
          {/* AI Profile Selector */}
          <div className="agent-console-profile-select">
            ...
            <p className="agent-console-profile-select__meta">
              {profileSwitching ? 'Switching runtime profile' : `${activeProfileInfo.type} - AI + Oracle Data`}
            </p>
          </div>
