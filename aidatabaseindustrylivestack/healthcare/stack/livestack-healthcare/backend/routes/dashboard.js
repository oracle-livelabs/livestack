...
// Compatibility route and mounted readiness route return the same honest
// declaration envelope. Neither route infers V$IM_SEGMENTS population, an
// In-Memory execution plan, compressed bytes, or a runtime-active state.
