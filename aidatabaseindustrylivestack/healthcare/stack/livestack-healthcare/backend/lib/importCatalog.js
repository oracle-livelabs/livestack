...
const TEMPLATE_NOTES = [
  ...
  'Domain labels keep the original schema names for compatibility: brands are manufacturers, products are healthcare operations, influencers are signal sources, and social_posts are regulatory or supply bulletins.',
