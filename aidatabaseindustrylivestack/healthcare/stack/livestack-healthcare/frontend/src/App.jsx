...
const CUSTOMER_STORAGE_KEY = 'healthcareLivestack.customerName';
...
const NAV_ITEMS = [
  ...
  { id: 'social', label: 'Quality & Capacity Signals', iconClass: 'oj-fwk-icon oj-fwk-icon-sortrelevancehigh', featureTags: ['Vector Search', 'VPD'] },
  { id: 'graph', label: 'Care Pathway Graph', iconClass: 'oj-fwk-icon oj-fwk-icon-node-expand', featureTags: ['Property Graph', 'SQL/PGQ'] },
  { id: 'fulfillment', label: 'Care Logistics Map', iconClass: 'oj-fwk-icon oj-fwk-icon-calendar-clock', featureTags: ['Oracle Spatial', 'VPD'] },
  { id: 'orders', label: 'Care Service Requests', iconClass: 'oj-fwk-icon oj-fwk-icon-tree-document', featureTags: ['JSON Duality', 'VPD'] },
  { id: 'oml', label: 'Risk and Capacity Analytics', iconClass: 'oj-fwk-icon oj-fwk-icon-view', featureTags: ['OML', 'Vector K-Means'] },
  { id: 'askdata', label: 'Ask Healthcare Data', iconClass: 'oj-fwk-icon oj-fwk-icon-magnifier', featureTags: ['Natural Language SQL', 'Live Schema'] },
  { id: 'agents', label: 'Healthcare AI Agent Console', iconClass: 'oj-fwk-icon oj-fwk-icon-users', featureTags: ['PL/SQL Tools', 'JSON Audit'] },
];
    ...
    <div className="customer-name-tool">
      ...
      {isOpen && (
        <form className="customer-name-tool__panel" onSubmit={submit}>
          ...
          <p className="customer-name-tool__hint">Replaces visible Seer Health, Seer Healthcare, Seer Equity, Seer Bank, and Seer labels. Seed-data participants such as NorthStar Health System remain part of the demo ecosystem.</p>
        </form>
      )}
    </div>
  );
          ...
          <div className="app-shell">
            ...
            <div className="app-main">
              <header className="app-topbar">
                ...
                <JetButton
                  label="Use Your Own Healthcare Data"
