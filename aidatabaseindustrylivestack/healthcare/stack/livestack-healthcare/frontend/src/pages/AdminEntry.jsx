...
export default function AdminEntry({
  ...
  const headerEyebrow = isOverlay ? 'Healthcare Dataset Tool' : 'Admin Entry';
  const headerContent = isOverlay ? 'Use Your Own Healthcare Data' : 'Healthcare Dataset Control';
  ...
  const quickActionLabel = isOverlay ? 'Jump To Upload' : 'Load Healthcare Dataset';
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="mt-2 text-xs tone-sienna max-w-3xl">
              Use synthetic or de-identified healthcare data only. Do not upload protected health information.
            </p>
          </div>
        ...
        <div className="mt-6 glass-card p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold">Restore Healthcare Demo Data</h2>
