/*
 * 16_healthcare_unified_audit_admin.sql
 * ADMIN-owned, idempotent Unified Audit policy for sensitive Healthcare DML.
 *
 * Usage:
 *   @16_healthcare_unified_audit_admin.sql LIVESTACK
 */
...
PROMPT Healthcare Unified Audit policy is installed and enabled.
