...
-- ============================================================
-- JSON DUALITY VIEW: Orders compatibility/internal (relational ↔ JSON)
-- Retains inherited field names for older API/import paths. Demo-facing SQL
-- and JSON examples should use CARE_SERVICE_REQUESTS_DV below.
-- ============================================================
...
-- ============================================================
-- JSON DUALITY VIEW: Care Service Requests
-- Healthcare-facing projection over the same ORDERS/ORDER_ITEMS
-- rows. The inherited ORDERS_DV remains for compatibility.
-- ============================================================
