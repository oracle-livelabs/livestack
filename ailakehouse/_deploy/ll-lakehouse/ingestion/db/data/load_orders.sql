/*
 * load_orders.sql
 * 3000 customer and partner orders with line items, varied statuses, and signal attribution
 */
...
BEGIN
    ...
    FOR i IN 1..3000 LOOP
        ...
        -- 30% of orders are signal-driven by demand, price, or operations bulletins
        ...
        -- Assign store fulfillment site for non-pending orders
        ...
        INSERT INTO orders (
            ...
            CASE
                WHEN DBMS_RANDOM.VALUE < 0.3 THEN 0          -- waived transaction fee
        ...
        IF v_status IN ('routed', 'completed') AND v_center_id IS NOT NULL THEN
            ...
            INSERT INTO shipments (
                ...
                CASE MOD(i, 4)
                    WHEN 0 THEN 'SecureCourier'
                    WHEN 1 THEN 'StoreLink'
                    WHEN 2 THEN 'WireTrack'
                    ELSE 'CustomerRoute'
                END,
                'FIN' || LPAD(v_order_id, 12, '0'),
