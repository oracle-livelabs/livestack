/*
 * load_graph_data.sql
 * Signal-source connections (3000+ edges) and brand or partner-source links
 */
...
BEGIN
    ...
    -- Generate brand or partner-source links (~1500)
    v_count := 0;
    ...
    COMMIT;
    DBMS_OUTPUT.PUT_LINE('Brand or Partner-source links loaded: ' || v_count);
END;
/
