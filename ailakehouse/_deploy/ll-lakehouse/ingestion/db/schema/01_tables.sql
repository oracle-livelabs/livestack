/*
 * 01_tables.sql
 * Core relational tables for Finance-Aware Customer Service
 * Oracle AI Database 26ai Free
 *
 * Run as: ADMIN or a dedicated schema owner (e.g., PG)
 */
...
-- ============================================================
-- INVENTORY (product capacity at each store fulfillment site)
-- ============================================================
