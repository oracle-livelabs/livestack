/*
 * 03_graph.sql
 * Property Graph for signal-source networks and brand or partner propagation
...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE v1.handle = '@demand_signal_01'
    COLUMNS (
        v2.handle,
        v2.influence_score,
        v2.follower_count
...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE a.handle = '@safety_signal_01'
      AND b.handle = '@store_signal_01'
    COLUMNS (
        a.handle AS source,
        b.handle AS target,
...
-- Brand or Partner propagation: which signal sources amplify a brand or partner through the network
...
FROM GRAPH_TABLE ( influencer_network
    ...
    WHERE b.brand_name = 'PeakGear Core'
    COLUMNS (
        v1.handle, v2.handle,
        e1.relationship_type,
        e2.connection_type,
