...
-- ============================================================
-- PRODUCT EMBEDDINGS compatibility marker: products are sporting goods products in this demo
-- MATERIAL EMBEDDINGS
-- Pre-computed vector embeddings for sporting goods product descriptions
-- Used to semantically match signal bulletin text -> sporting goods products
-- ============================================================
...
-- Stores computed matches between signal bulletins and sporting goods products
-- ============================================================
...
-- ============================================================
-- WEBSHOP PRODUCT IMAGE EMBEDDINGS
-- Stores CLIP image vectors generated by the Private AI Services container
-- for product catalog images mounted with the app.
-- ============================================================
CREATE TABLE webshop_product_image_embeddings (
    ...
    embedding_model  VARCHAR2(100) DEFAULT 'clip-vit-base-patch32-img',
    embedding        VECTOR(512, FLOAT32),
    created_at       TIMESTAMP DEFAULT SYSTIMESTAMP
);

-- ============================================================
-- WEBSHOP IMAGE SEARCH UPLOADS
-- Suggested AI Lakehouse table for shopper-uploaded image searches.
-- The image binary lands in Object Storage; this table stores the reference,
-- model metadata, embedding, and top match summary for later analyst review.
-- ============================================================
...
CREATE INDEX idx_webshop_upload_product ON webshop_image_search_uploads(top_product_id);
CREATE INDEX idx_webshop_upload_time ON webshop_image_search_uploads(uploaded_at DESC);

-- ============================================================
-- VECTOR SEARCH PROCEDURES
-- ============================================================

-- Find sporting goods products semantically similar to a signal bulletin
...
-- Batch process: find sporting goods products for all unprocessed signal bulletins
