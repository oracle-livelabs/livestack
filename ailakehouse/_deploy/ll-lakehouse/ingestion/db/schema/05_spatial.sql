...
-- Store fulfillment sites: location geometry
ALTER TABLE fulfillment_centers ADD (
    location SDO_GEOMETRY
);

-- Customer LOCATION column is defined on the customers table in 01_tables.sql
...
CREATE TABLE demand_regions (
    ...
    social_density    NUMBER(8,2),      -- market/market signals per 1000 population
...
-- Find the N nearest store fulfillment sites to a customer
-- that have the requested sporting goods product available
-- ============================================================
