...
define(['ojs/ojcore-base', 'ojs/ojdvt-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojconverterutils-i18n', 'ojs/ojconverter-number', 'ojs/ojlogger', 'ojs/ojchart-toolkit'], function (oj, DvtAttributeUtils, ojcomponentcore, $, ConverterUtils, NumberConverter, Logger, ojchartToolkit) { 'use strict';
   ...
   * @ojvalue {string} "capacity" Series will be represented by candlestick markers. There are other representations available like area, bar, line and line with area.
  ...
  /**
   * Object type defining the overview scrollbar. Only applies if zoomAndScroll is not off. Currently only supported for vertical bar, line, area, capacity, and combo charts.
   ...
   * @property {number} low The low value of the data item present in range bar/area, capacity candlestick, or box plot item.
   * @property {number} high The high value of the data item present in range bar/area, capacity candlestick, or box plot item.
   * @property {number} open The open value of the hovered capacity chart item.
   * @property {number} close The close value of the hovered capacity chart item.
   * @property {number} volume The volume value of the hovered capacity chart item.
   ...
   * @property {number} low The low value of the data item present in range bar/area, capacity candlestick, or box plot item.
   * @property {number} high The high value of the data item present in range bar/area, capacity candlestick, or box plot item
   * @property {number} open The open value of the capacity chart data item.
   * @property {number} close The close value of the capacity chart data item.
   * @property {number} volume The volume value of the capacity chart data item.
   ...
   */
  /**
   * Defines whether the plot area is split into two sections, so that sets of data assigned to the different Y-axes appear in different parts of the plot area. Capacity charts do not support "off".
   * @expose
   * @name splitDualY
   * @memberof oj.ojChart
   * @instance
   ...
   * @ojvalue {string} "auto" Plot area will not be split into two sections except for the capacity charts.
   * @default "auto"
   */
  /**
   ...
   */
  /**
   * The type of time axis to display in the chart. Time axis is only supported for Cartesian bar, line, area, capacity, box plot, and combo charts. If the value is "enabled" or "skipGaps", the time values must be provided through the "group-id" attribute of the oj-chart-item element. In this case stacking is supported. If the value is "skipGaps", the groups will be rendered at a regular interval regardless of any time gaps that may exist in the data. If the value is "mixedFrequency", the time values must be provided through the "x" attribute of the oj-chart-item element. In this case stacking is not supported.
   * The time values provided through "group-id" or "x" attribute of the oj-chart-item must be an ISO string.
   * @expose
   * @name timeAxisType
   * @memberof oj.ojChart
   * @ojshortdesc The type of time axis to display in the chart. Time axis is only supported for Cartesian bar, line, area, capacity, box plot, and combo charts. See the Help documentation for more information.
   * @instance
   * @type {string=}
   ...
   * @ojvalue {string} "auto" Time axis is disabled unless it is a capacity chart, for which the timeAxisType is mixedFrequency.
   * @default "auto"
   */
  /**
   ...
   */
  /**
   * An object defining the overview scrollbar. Only applies if zoomAndScroll is not off. Currently only supported for vertical bar, line, area, capacity, and combo charts.
   * @expose
   * @name overview
   * @memberof oj.ojChart
   * @instance
   ...
   * @ojdisplayname Capacity Chart
   * @ojstylevariable oj-chart-capacity-falling-bg-color {description: "Capacity chart falling capacity background color", formats: ["color"], help: "#oj-chart-css-set3"}
   * @ojstylevariable oj-chart-capacity-range-bg-color {description: "Capacity chart capacity range background color", formats: ["color"], help: "oj-chart-css-set3"}
   * @ojstylevariable oj-chart-capacity-rising-bg-color {description: "Capacity chart rising capacity background color", formats: ["color"], help: "oj-chart-css-set3"}
   * @memberof oj.ojChart
   */
   ...
   */
  /**
   * Defines whether the legend is displayed. If set to auto, the legend will be hidden for charts with a large number of series. To ensure that the legend is always displayed, set this attribute to 'on'. To turn on legend for capacity, funnel and pyramid charts, set the displayInLegend property for the series items to 'on'.
   * @expose
   * @name rendered
   * @ojtypedefmember
   * @memberof! oj.ojChart.Legend
   ...
   */
  /**
   * In capacity charts, the color of the candlestick when the 'close' value is greater than the 'open' value.
   * @expose
   * @name capacityRisingColor
   * @ojtypedefmember
   * @memberof! oj.ojChart.StyleDefaults
   * @type {string=}
   * @ojformat color
   ...
   */
  /**
   * In capacity charts, the color of the candlestick when the 'open' value is greater than the 'close' value.
   * @expose
   * @name capacityFallingColor
   * @ojtypedefmember
   * @memberof! oj.ojChart.StyleDefaults
   * @type {string=}
   * @ojformat color
   ...
   */
  /**
   * In capacity charts, the color of the range bars for candlestick.
   * @expose
   * @name capacityRangeColor
   * @ojtypedefmember
   * @memberof! oj.ojChart.StyleDefaults
   * @type {string=}
   * @ojformat color
   ...
   */
  /**
   * In capacity charts, the color of the volume bars. If specified, overrides the default rising and falling colors used by the volume bars.
   * @expose
   * @name capacityVolumeColor
   * @ojtypedefmember
   * @memberof! oj.ojChart.StyleDefaults
   * @type {string=}
   * @ojformat color
   ...
   * @property {Object=} open Specifies the value formatting and tooltip behavior for the open values of a capacity chart.
   * @property {Object=} close Specifies the value formatting and tooltip behavior for the close values of a capacity chart.
   * @property {Object=} volume Specifies the value formatting and tooltip behavior for the volume values of a capacity chart.
...
var __oj_spark_chart_item_metadata = 
{
   ...
   * @ojuxspecs ['dvtChart_BarLineAreaCombo', 'range-chart', 'pie-chart', 'polar-chart', 'funnel-chart', 'pyramid-chart', 'capacity-chart', 'data-visualization-common']
   *
   ...
   * </h3>
   *
   * <p>JET Chart with support for bar, line, area, combination, pie, scatter, bubble, funnel, box plot, and capacity
   * chart types.</p>
   *
  ...
  oj.__registerWidget('oj.ojChart', $.oj.dvtBaseComponent, {
    ...
    options: {
       ...
       * Only a single series is supported for capacity charts. Also accepts a Promise for deferred data rendering.
       * @expose
       * @ojtsignore
       * @name series
       * @memberof oj.ojChart
    ...
    _GetLoadingSkeletonMaskStyleClass: function () {
      const typeClassMap = {
        ...
        capacity: 'oj-chart-boxplot-skeleton-container',
    ...
    _GetChildStyleClasses: function () {
      ...
      styleClasses['oj-chart-capacity-falling'] = {
        path: 'styleDefaults/capacityFallingColor',
        property: 'background-color'
      };
      styleClasses['oj-chart-capacity-range'] = {
        path: 'styleDefaults/capacityRangeColor',
        property: 'background-color'
      };
      styleClasses['oj-chart-capacity-rising'] = {
        path: 'styleDefaults/capacityRisingColor',
        property: 'background-color'
      };
     ...
     * @property {number} close The closing value for a capacity item
     * @property {string} group The group id.
     * @property {number} high The high value for a range or capacity item
     * @property {string} label
     * @property {number} low  The low value for a range or capacity item
     * @property {number} open The opening value for a capacity item
     * @property {boolean} selected
     * @property {string} series The series id.
     * @property {number} targetValue The target value for a funnel slice.
     * @property {string} tooltip
     * @property {number} value
     * @property {number} volume  The volume of a capacity item
     * @property {number} x
     * @property {number} y
     * @property {number} z
