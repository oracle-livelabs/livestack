...
MessageViewModel.prototype._openMessage = function () {
  ...
  if (messageContainerElement) {
    ...
    if (this._isInlinedChildOfOjMessages()) {
      ...
      //  events do not get completed, since the parent oj-messages is not created yet. For this
...
OperationMediator.prototype._init = function () {
  ...
  // be invoked when the resolved queue is completed (operation completes).
 ...
 * target operation is completed to the target element.
 *
 * @public
