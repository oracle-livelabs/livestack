...
define(['exports'], function (exports) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var _a;
    var SPACE_SOCCRATOR_START_REGEX = new RegExp("^".concat(SPACE_SOCCRATOR_REGEX.source, "*"));
    var SPACE_SOCCRATOR_END_REGEX = new RegExp("".concat(SPACE_SOCCRATOR_REGEX.source, "*$"));
    ...
    var trimStart = hasTrimStart
        ...
        : // Ponyfill
            function trimStart(s) {
                return s.replace(SPACE_SOCCRATOR_START_REGEX, '');
            };
    var trimEnd = hasTrimEnd
        ...
        : // Ponyfill
            function trimEnd(s) {
                return s.replace(SPACE_SOCCRATOR_END_REGEX, '');
            };
    ...
    */
    ...
    // @generated from regex-gen.ts
    var SPACE_SOCCRATOR_REGEX$1 = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;
    ...
    var _a$1;
    var SPACE_SOCCRATOR_START_REGEX$1 = new RegExp("^".concat(SPACE_SOCCRATOR_REGEX$1.source, "*"));
    var SPACE_SOCCRATOR_END_REGEX$1 = new RegExp("".concat(SPACE_SOCCRATOR_REGEX$1.source, "*$"));
    ...
    var trimStart$1 = hasTrimStart$1
        ...
        : // Ponyfill
            function trimStart(s) {
                return s.replace(SPACE_SOCCRATOR_START_REGEX$1, '');
            };
    var trimEnd$1 = hasTrimEnd$1
        ...
        : // Ponyfill
            function trimEnd(s) {
                return s.replace(SPACE_SOCCRATOR_END_REGEX$1, '');
            };
    // Prevent minifier to translate new RegExp to literal form that might cause syntax error on IE11.
