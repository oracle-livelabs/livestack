...
const ROLE_META = {
  ...
  fulfillment_mgr: { label: 'Store Mgr', color: '#4C825C', desc: 'Regional inventory & transaction routing' },
  merchandiser:    { label: 'Assortment Planner', color: '#AA643B', desc: 'Products and demand signals' },
