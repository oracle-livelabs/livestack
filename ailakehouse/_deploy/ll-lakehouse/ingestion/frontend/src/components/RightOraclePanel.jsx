  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 overflow-hidden" style={{ marginLeft: collapsed ? 0 : 8 }}>
        ...
        >
          {collapsed ? (
            <JetGlyph iconClass="oj-fwk-icon-grid" className="mx-auto text-[var(--color-accent)]" />
          ) : (
            <>
              <JetGlyph iconClass="oj-fwk-icon-grid" className="text-[var(--color-accent)] flex-shrink-0" />
              ...
              <JetGlyph iconClass="oj-fwk-icon-next" className="text-[var(--color-text-dim)] flex-shrink-0" />
            </>
          )}
        </button>
