...
import { JetGlyph } from './JetControls';
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="app-user-switcher-button w-full flex items-center gap-2.5 px-3 py-2.5 text-left transition-all"
        style={{
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {currentUser.REGION && (
              <span className="text-[9px] text-[var(--color-sidebar-text-dim)] flex items-center gap-0.5">
                <JetGlyph iconClass="oj-fwk-icon-info" /> {currentUser.REGION}
              </span>
            )}
          </div>
        </div>
        <JetGlyph
          ...
          className="text-[var(--color-sidebar-text-dim)] flex-shrink-0 transition-transform"
      ...
      {open && (
        ...
        >
          ...
          >
            <JetGlyph iconClass="oj-fwk-icon-info" className="text-[var(--color-accent)]" />
