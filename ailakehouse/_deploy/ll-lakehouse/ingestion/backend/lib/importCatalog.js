...
const TEMPLATE_NOTES = [
  ...
  'Domain labels keep the original schema names for compatibility: brands are brands and partners, products are sporting goods products, influencers are signal sources, and social_posts are market or market bulletins.',
...
function buildManifest() {
  return {
    ...
    format: 'peakgear-sporting-goods-import',
